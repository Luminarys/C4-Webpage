...
<head>
	...
	<script type="text/javascript" charset="utf8" src="js/functional_query.js"></script>
	...
	<div id="wrapper" class="Site-content">
		...
		<div id="contents">
			...
			<div id="entryForm">
				...
				<div id="functionalForm" class="entryForm">
					<button class="backToQuery">Back to query selection</button>
					<p>View Functional Enrichment:</p>
					<form id='functionalQueryForm'>
							<input type="text" id="moduleInput" placeholder="Module #">
